...
AndsCons::AndsCons( std::string const& arg1, std::shared_ptr< Ands > const& arg2 )
  :std::tuple< std::string, std::shared_ptr< Ands > >( arg1, arg2 ) {}
...
EdgeAttrsCons::EdgeAttrsCons( std::shared_ptr< EdgeAttr > const& arg1, std::shared_ptr< EdgeAttrs > const& arg2 )
  :std::tuple< std::shared_ptr< EdgeAttr >, std::shared_ptr< EdgeAttrs > >( arg1, arg2 ) {}
...
NodeAttrsCons::NodeAttrsCons( std::shared_ptr< NodeAttr > const& arg1, std::shared_ptr< NodeAttrs > const& arg2 )
  :std::tuple< std::shared_ptr< NodeAttr >, std::shared_ptr< NodeAttrs > >( arg1, arg2 ) {}
...
StmtsCons::StmtsCons( std::shared_ptr< Stmt > const& arg1, std::shared_ptr< Stmts > const& arg2 )
  :std::tuple< std::shared_ptr< Stmt >, std::shared_ptr< Stmts > >( arg1, arg2 ) {}
...
Node3::Node3( std::shared_ptr< Ands > const& arg1_)
    :arg1( arg1_ ) {}
...
Node8::Node8( std::shared_ptr< Stmts > const& arg1_)
    :arg1( arg1_ ) {}

Node9::Node9( std::string const& arg1_)
    :arg1( arg1_ ) {}

Node10::Node10( std::string const& arg1_)
    :arg1( arg1_ ) {}

Node11::Node11( std::shared_ptr< EdgeAttr > const& arg1_)
    :arg1( arg1_ ) {}

Node12::Node12( std::shared_ptr< Ands > const& arg1_)
    :arg1( arg1_ ) {}

Node13::Node13( std::string const& arg1_)
    :arg1( arg1_ ) {}

Node14::Node14( std::shared_ptr< EdgeAttrs > const& arg1_)
    :arg1( arg1_ ) {}

Node15::Node15( std::shared_ptr< EdgeAttrs > const& arg1_)
    :arg1( arg1_ ) {}

Node16::Node16( std::shared_ptr< Stmt > const& arg1_)
    :arg1( arg1_ ) {}

Node17::Node17( std::string const& arg1_)
    :arg1( arg1_ ) {}

Node18::Node18( std::shared_ptr< Ands > const& arg1_)
    :arg1( arg1_ ) {}
...
Node21::Node21( std::shared_ptr< Ands > const& arg1_)
    :arg1( arg1_ ) {}

Node22::Node22( std::string const& arg1_)
    :arg1( arg1_ ) {}

Node23::Node23( std::shared_ptr< NodeAttrs > const& arg1_)
    :arg1( arg1_ ) {}

Node24::Node24( std::shared_ptr< NodeAttrs > const& arg1_)
    :arg1( arg1_ ) {}

Node25::Node25( std::shared_ptr< Stmts > const& arg1_)
    :arg1( arg1_ ) {}

Node26::Node26( std::shared_ptr< Stmts > const& arg1_)
    :arg1( arg1_ ) {}
