...
and_' :: (And_Transition src dst) => src -> String -> (dst -> r) -> r
and_' src arg k = src |> and_ arg |> k

color' :: (ColorTransition src dst) => src -> String -> (dst -> r) -> r
color' src arg k = src |> color arg |> k

style' :: (StyleTransition src dst) => src -> String -> (dst -> r) -> r
style' src arg k = src |> style arg |> k

digraph' :: (DigraphTransition src dst) => src -> String -> (dst -> r) -> r
digraph' src arg k = src |> digraph arg |> k

graph' :: (GraphTransition src dst) => src -> String -> (dst -> r) -> r
graph' src arg k = src |> graph arg |> k

shape' :: (ShapeTransition src dst) => src -> String -> (dst -> r) -> r
shape' src arg k = src |> shape arg |> k

node' :: (NodeTransition src dst) => src -> String -> (dst -> r) -> r
node' src arg k = src |> node arg |> k

edge' :: (EdgeTransition src dst) => src -> String -> (dst -> r) -> r
edge' src arg k = src |> edge arg |> k

to' :: (ToTransition src dst) => src -> String -> (dst -> r) -> r
to' src arg k = src |> to arg |> k

end' :: (EndTransition src dst) => src -> dst
end' = end
